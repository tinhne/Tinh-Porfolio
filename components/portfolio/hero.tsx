    ...
    <section id="hero" className="min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-8">
        ...
        >
          ...
          <span className="text-muted-foreground ml-auto hidden md:block">{time} ICT</span>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold leading-[1.1] tracking-tight text-balance">
              ...
              <br />
              <span className="italic text-muted-foreground">from scratch.</span>
            </h1>

            <div className="mt-12 max-w-lg">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Fresher Developer passionate about building
                <span className="text-foreground font-medium"> Full Stack</span> applications with 
                <span className="text-foreground font-medium"> Node.js</span>, 
                <span className="text-foreground font-medium"> NestJS</span> & 
                <span className="text-foreground font-medium"> Next.js</span>.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                Eager to learn and grow. Open to work anywhere, ready to take on new challenges.
              </p>
            </div>
          ...
          >
            ...
            <div className="border border-border p-6 bg-card">
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                A curious developer who loves building things from scratch. 
                Open to learning any technology that the job requires. 
            ...
            <div className="border border-border bg-card overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-2 border-b border-border bg-secondary/50">
                ...
                <span className="font-mono text-xs text-muted-foreground ml-2">developer.ts</span>
              </div>
